...
function ProductsStats({ stats }) {
  return (
    <Grid container margin="0px" spacing={2} display="flex" sx={{
      ...
      <Grid item><StatCard title="Average Rating" value={Number(stats.avg_rating).toFixed(2)} color="#ff8c66" /></Grid>
      <Grid item><StatCard title="Out Of Stock" value={stats.out_of_stock_count} color="#3e93b4" /></Grid>
    </Grid>
  );
}
