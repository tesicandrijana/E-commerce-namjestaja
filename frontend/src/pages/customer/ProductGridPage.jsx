...
export default function ProductGridPage({ title, description, fetchUrl, renderSidebar }) {
  ...
  // Fetch all products from backend (no pagination on backend)
  useEffect(() => {
    fetch(fetchUrl)
      .then((res) => res.json())
  ...
  // Fetch discounted prices for visible products
  useEffect(() => {
  ...
  // Filter products client-side by category and search query
  ...
  <div className="product-page-background">
    <div className="product-header-section">
      <div className="header-overlay">
        ...
        <div
          className="category-list-search-container"
          style={{ marginTop: 16 }}
        >
  ...
  {renderSidebar && (
    <aside className="products-sidebar-wrapper">
      {renderSidebar()}
    </aside>
  )}
      ...
      <main className="products-blurred-background">
        ...
        {filteredProducts.length > PRODUCTS_PER_PAGE && (
          <div className="show-more-wrapper">
            ...
            <span
              style={{ margin: "0 12px", fontSize: "15px", fontWeight: 500 }}
            >
